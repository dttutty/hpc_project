output_file="result/compare_jacobiomp_gauss_gaussomp.csv"
...
for sparse in 0.1 0.9 0.99; do
    for size in {100..2000..100}; do
        ...
        echo "Matrix size: $size, Sparsity: $sparse, Jacobi OMP execution time: $jacobi_omp_exec_time ms, Gauss-Seidel execution time: $gauss_seidel_exec_time ms, Gauss-Seidel OMP execution time: $gauss_seidel_omp_exec_time ms"
